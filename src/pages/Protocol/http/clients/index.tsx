import HttpHandlerUpdateForm from '@/pages/Protocol/http/clients/HttpHandlerUpdateForm';
import {
  addHttpHandler,
  delteHttpHandler,
  deviceList,
...
const handlerUpdate = async (fields: API.HttpHandlerListItem) => {
  const hide = message.loading('正在更新');
  try {
    await updateHttpHandler({ ...fields });
    hide();
...
const Admin: React.FC = () => {
  ...
  return (
    <PageContainer>
      <ProTable<API.HttpHandlerListItem, API.PageParams>
